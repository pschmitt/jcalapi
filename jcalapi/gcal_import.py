...
def ics_to_gcal(ical_event):
    ...
    watermark = (
        "<br><i>Imported by https://github.com/pschmitt/gcal-import-ics</i>"
    )
    gcal_event.description = (
        gcal_event.description if gcal_event.description else ""
    ) + watermark
...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Watermark. Store metadata inside calendar events",
    )
